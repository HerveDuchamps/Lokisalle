...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 20 Mars 2017 à 12:17
...
CREATE TABLE `avis` (
  ...
  `note` int(2) NOT NULL,
  `date_engistrement` datetime NOT NULL
...
ALTER TABLE `commande`
  ...
  ADD CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id_produit`) ON UPDATE CASCADE;
